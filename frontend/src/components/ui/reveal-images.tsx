...
const defaultItems: ShowImageListItemProps[] = [
  {
    ...
    images: [
      {
        src: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=200&auto=format&fit=crop&q=60",
        alt: "Restaurant kitchen",
      },
      {
        src: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=200&auto=format&fit=crop&q=60",
        alt: "Restaurant plating food",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: "https://images.unsplash.com/photo-1593113598332-cd288d649433?w=200&auto=format&fit=crop&q=60",
        alt: "Food bank volunteers",
      },
      {
        src: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=200&auto=format&fit=crop&q=60",
        alt: "Donated food",
      },
    ],
  },
  {
    ...
    images: [
      {
        src: "https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=200&auto=format&fit=crop&q=60",
        alt: "Local farm",
      },
      {
        src: "https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=200&auto=format&fit=crop&q=60",
        alt: "Farm produce",
      },
    ],
  },
...
function RevealImageList({ label = "Food sources", items = defaultItems }: RevealImageListProps) {
  return (
    <div className="flex flex-col gap-1 rounded-sm bg-background px-8 py-4">
      <h3 className="text-sm font-black uppercase text-muted-foreground">{label}</h3>
